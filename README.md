...
This project will use a public mental health app review dataset. The analysis will focus on publicly available user feedback rather than private clinical records or sensitive patient-level data.
